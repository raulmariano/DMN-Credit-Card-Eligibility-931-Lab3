 ...
 * under the License.
 */
package https_58_47_47kie_46org_47dmn_47__C4239145_45C39C_454DC4_45A69B_4528D67B7D5DF0;
...
@Path("/DMN_9C4AC081-8064-4CB4-9189-2B737F521BBA")
@org.eclipse.microprofile.openapi.annotations.tags.Tag(name = "Decision - DMN_9C4AC081-8064-4CB4-9189-2B737F521BBA", description = "")
public class DMN__9C4AC081_458064_454CB4_459189_452B737F521BBAResource {
    ...
    @org.eclipse.microprofile.openapi.annotations.Operation(operationId = "evaluateDmn_DMN_9C4AC081-8064-4CB4-9189-2B737F521BBA", summary = "It evaluates the DMN_9C4AC081-8064-4CB4-9189-2B737F521BBA DMN Model")
    @org.eclipse.microprofile.openapi.annotations.parameters.RequestBody(content = @org.eclipse.microprofile.openapi.annotations.media.Content(mediaType = "application/json", schema = @org.eclipse.microprofile.openapi.annotations.media.Schema(ref = "/refs/CreditCardEligibility.json#/definitions/InputSet")), description = "DMN input")
    @org.eclipse.microprofile.openapi.annotations.responses.APIResponse(content = @org.eclipse.microprofile.openapi.annotations.media.Content(mediaType = "application/json", schema = @org.eclipse.microprofile.openapi.annotations.media.Schema(ref = "/refs/CreditCardEligibility.json#/definitions/OutputSet")), description = "DMN output")
    public Response dmn(java.util.Map<String, Object> variables) {
        org.kie.kogito.decision.DecisionModel decision = application.get(org.kie.kogito.decision.DecisionModels.class).getDecisionModel("https://kie.org/dmn/_C4239145-C39C-4DC4-A69B-28D67B7D5DF0", "DMN_9C4AC081-8064-4CB4-9189-2B737F521BBA");
        org.kie.dmn.api.core.DMNResult decisionResult = decision.evaluateAll(DMNJSONUtils.ctx(decision, variables));
        KogitoDMNResult result = new KogitoDMNResult("https://kie.org/dmn/_C4239145-C39C-4DC4-A69B-28D67B7D5DF0", "DMN_9C4AC081-8064-4CB4-9189-2B737F521BBA", decisionResult);
        return enrichResponseHeaders(decisionResult, extractContextIfSucceded(result));
    }

    @GET
    @Produces(MediaType.APPLICATION_XML)
    @org.eclipse.microprofile.openapi.annotations.Operation(operationId = "getDmn_DMN_9C4AC081-8064-4CB4-9189-2B737F521BBA", summary = "Get the DMN DMN_9C4AC081-8064-4CB4-9189-2B737F521BBA model file")
    public String dmn() throws java.io.IOException {
        try (InputStream is = this.getClass().getResourceAsStream(CodegenStringUtil.escapeIdentifier("DMN_9C4AC081-8064-4CB4-9189-2B737F521BBA") + ".dmn_nologic")) {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    @org.eclipse.microprofile.openapi.annotations.Operation(operationId = "evaluateDmnFullResults_DMN_9C4AC081-8064-4CB4-9189-2B737F521BBA", summary = "It evaluates the DMN_9C4AC081-8064-4CB4-9189-2B737F521BBA DMN Model")
    @org.eclipse.microprofile.openapi.annotations.parameters.RequestBody(content = @org.eclipse.microprofile.openapi.annotations.media.Content(mediaType = "application/json", schema = @org.eclipse.microprofile.openapi.annotations.media.Schema(ref = "/refs/CreditCardEligibility.json#/definitions/InputSet")), description = "DMN input")
